...
def copy_deskpaper(file_folder1, file_folder2, prefix = "WallPaper"):
...
def main():
    ...
    copy_deskpaper(windows11_lockscreen_folder, mypictures_folder, "WallPaper")
    # 备份桌面图片文件
    source_folder = get_windows11_desktop_folder()
    #open_folder(source_folder)
    # 复制桌面图片：命名规则有所变化
    copy_deskpaper(source_folder, mypictures_folder, "Desktop")
